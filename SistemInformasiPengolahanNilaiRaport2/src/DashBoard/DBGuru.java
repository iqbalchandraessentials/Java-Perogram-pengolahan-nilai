...
import GUI_IM.GNilai;
import GUI_IM.GProduktif;
 ...
 * @author fidia
 */
public class DBGuru extends javax.swing.JFrame {
    ...
    GNilai gn = new GNilai();
    GProduktif gp = new GProduktif();
    ...
    private void initComponents() {
        ...
        btmInputPro = new rojerusan.RSButtonIconI();
        btmInput1 = new rojerusan.RSButtonIconI();
        jPanel1 = new javax.swing.JPanel();
        txmUser2 = new javax.swing.JLabel();
        logUser3 = new javax.swing.JLabel();
        jMenuBar1 = new javax.swing.JMenuBar();
        jMenu1 = new javax.swing.JMenu();
        jmInput = new javax.swing.JMenuItem();
        ...
        btmInputPro.setBackground(new java.awt.Color(0, 102, 153));
        btmInputPro.setForeground(new java.awt.Color(0, 0, 0));
        btmInputPro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/book-64.png"))); // NOI18N
        btmInputPro.setText("NILAI PRODUKTIF");
        btmInputPro.setToolTipText("Input nilai produktif");
        btmInputPro.setActionCommand("Siswa");
        btmInputPro.setColorText(new java.awt.Color(0, 0, 0));
        btmInputPro.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btmInputPro.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btmInputPro.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btmInputPro.setMargin(new java.awt.Insets(2, 82, 2, 14));
        btmInputPro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btmInputProActionPerformed(evt);
            }
        });
        jPanel4.add(btmInputPro, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 220, 60));

        btmInput1.setBackground(new java.awt.Color(0, 102, 153));
        btmInput1.setForeground(new java.awt.Color(0, 0, 0));
        btmInput1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/book-64.png"))); // NOI18N
        btmInput1.setText("INPUT NILAI");
        btmInput1.setToolTipText("Input nilai");
        btmInput1.setActionCommand("Siswa");
        btmInput1.setColorText(new java.awt.Color(0, 0, 0));
        btmInput1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btmInput1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btmInput1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btmInput1.setMargin(new java.awt.Insets(2, 82, 2, 14));
        btmInput1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btmInput1ActionPerformed(evt);
            }
        });
        jPanel4.add(btmInput1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 220, 60));
        ...
        jmInput.setText("Input Nilai");
        jmInput.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmInputActionPerformed(evt);
            }
        });
        jMenu1.add(jmInput);

        jMenuItem1.setText("Input Nilai Produktif");
    ...
    private void btmInputProActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmInputProActionPerformed
        // input nilai
        gp.setVisible(true);
    }//GEN-LAST:event_btmInputProActionPerformed
    ...
    private void jmInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmInputActionPerformed
        // jm input
        gn.setVisible(true);
    }//GEN-LAST:event_jmInputActionPerformed

    private void btmInput1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmInput1ActionPerformed
        // TODO add your handling code here:
        gn.setVisible(true);
    }//GEN-LAST:event_btmInput1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DBGuru().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private rojerusan.RSButtonIconI btmInput1;
    private rojerusan.RSButtonIconI btmInputPro;
    ...
    private javax.swing.JMenuItem jmInput;
