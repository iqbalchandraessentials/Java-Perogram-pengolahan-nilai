 ...
 * @author fidia
 */
public class GRSiswa extends javax.swing.JFrame {
    ...
    public GRSiswa() {
     ...
     protected void dataTable(){
        Object [] baris = {"id siswa","Nama","Jenkel","Alamat","Telp"};
        tabmode = new DefaultTableModel(null, baris);
        tbSiswaL.setModel(tabmode);
    ...
    public void TabelKlik(){
        int bar = tbSiswaL.getSelectedRow();
    ...
    private void makePreview (String vName){
        try {
            ...
            parameter.put("idsiswa", String.valueOf(txid.getText()));
    ...
    private void initComponents() {
        ...
        tbSiswaL = new javax.swing.JTable();
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 140, -1));
        ...
        tbSiswaL.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tbSiswaL.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbSiswaLMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbSiswaL);
    ...
    private void tbSiswaLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbSiswaLMouseClicked
        // TODO add your handling code here:
        TabelKlik();
    }//GEN-LAST:event_tbSiswaLMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GRSiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbSiswaL;
